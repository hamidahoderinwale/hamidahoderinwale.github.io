---
title: "Questioning the Arrow"
date: 2023-01-18
subtitle: "I wrote this for a class, but thought I would add it here. I'm too lazy to fix the formatting errors, but maybe I'll come back to them later. I'm largely posting this after being inspired by Anson Ho's blog which I found very cool : )"
layout: post
---

The arrow of time is our current notion of the direction in which time passes: forward. This means that time is asymmetric. It is described as "a three-dimensional Euclidean spatial manifold that changes along an inexorable arrow of time."[^1]

It explains the casualties within our universe and the concept of causality at all. As with many physical phenomena, the development from Newtonian to Quantum mechanics shakes up the principles we've come to understand about the universe. Statistical mechanics and quantum ideas propose that "the flow" of time could be symmetric and all events could be reversible.
...
## Reasons for Investigating this Subject
...
## Developments in the Notion of Time
...
## A Scientific Revolution: A Pre-Arrow Time[^3]
...
## Eddington and More: The Flow of Time
...
## Exploring the Cosmological Conception
...
## Reconsidering Time Through Relativity
...
## Exploring the Mind-Time Relationship
...
## Questioning Time Across Possible Worlds
...
## Gaining Empirical Insight into the Arrow of Time
